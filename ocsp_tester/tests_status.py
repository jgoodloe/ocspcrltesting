...
def run_status_tests(
    ...
    if should_run("Known revoked certificate returns revoked"):
    ...
    # 3. Unknown CA
    if should_run("Unknown CA returns unknown"):
    ...
    if should_run("Non-issued certificate handling"):
    ...
    # 5. Timeliness fields
    if should_run("thisUpdate/nextUpdate/producedAt present and plausible"):
